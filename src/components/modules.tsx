  ...
  return (
    <>
      ...
      <section className="data-panel">
        ...
        {!loadError ? <div className="table-wrap" tabIndex={0} role="region" aria-label="Tabel stok filamen">
